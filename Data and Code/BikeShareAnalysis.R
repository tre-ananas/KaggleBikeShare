...
tuning_grid <- grid_regular(mtry(range = c(1, 9)), # Grid of values to tune over
                            min_n(),
                            levels = 3) # levels = L means L^2 total tuning possibilities
...
tuning_grid <- grid_regular(mtry(range = c(1, 9)), # Grid of values to tune over
                            min_n(),
                            levels = 10) # levels = L means L^2 total tuning possibilities
